...
function AdminAnalytics() {
  ...
  if (isLoading) {
    return <div className="p-8 space-y-4 font-['Cairo'] text-center">جاري تحميل البيانات...</div>;
  }
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 font-['Cairo']" dir="rtl">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">تحليلات الأداء</h1>
        <p className="text-muted-foreground mt-2">نظرة شاملة على تقدم الطلاب وتفاعلهم مع المحتوى.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="glass border-white/20">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">طلاب مسجلون حالياً</p>
          </CardContent>
        </Card>
        ...
        <Card className="glass border-white/20">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">تم إصدارها هذا الأسبوع</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="glass border-white/20">
          <CardHeader>
            ...
            <CardDescription>بناءً على نتائج اختبار تحديد المستوى</CardDescription>
          </CardHeader>
        ...
        <Card className="glass border-white/20">
          <CardHeader>
            <CardTitle>نسب إكمال المستويات</CardTitle>
            <CardDescription>مقارنة بين عدد الدروس المكتملة والإجمالي</CardDescription>
          </CardHeader>
          <CardContent className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <Card className="glass border-white/20">
        <CardHeader>
          <CardTitle>أبرز الكورسات</CardTitle>
          <CardDescription>الكورسات الأكثر طلباً وتفاعلاً من قبل الطلاب</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div key={course.id} className="flex items-center justify-between p-4 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors border border-white/5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">السعر: {course.price} EGP</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-bold text-emerald-500">+15%</div>
                  <div className="text-[10px] text-muted-foreground">نمو أسبوعي</div>
                </div>
              </div>
            ))}
          </div>
